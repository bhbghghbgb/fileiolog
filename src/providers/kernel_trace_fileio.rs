...
etw_provider! {
    ...
    pub enum KernelTraceFileIoEvent {
        ...
        #[etw_event(name = "PreOpInitV3", id = 96, version = 3, enable_flag = flags::PERF_FLT_IO_INIT)]
        #[etw_event(name = "PostOpInitV3", id = 97, version = 3, enable_flag = flags::PERF_FLT_IO_INIT)]
        ...
        #[etw_event(name = "PreOpCompletionV3", id = 98, version = 3, enable_flag = flags::PERF_FLT_IO)]
        #[etw_event(name = "PostOpCompletionV3", id = 99, version = 3, enable_flag = flags::PERF_FLT_IO)]
        ...
        #[etw_event(name = "PreOpFailureV3", id = 100, version = 3, enable_flag = flags::PERF_FLT_IO_FAILURE)]
        #[etw_event(name = "PostOpFailureV3", id = 101, version = 3, enable_flag = flags::PERF_FLT_IO_FAILURE)]
