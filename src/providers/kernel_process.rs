...
impl crate::etw::EtwPropConvert<ferrisetw::native::time::FileTime> for time::OffsetDateTime {
    fn convert(value: ferrisetw::native::time::FileTime) -> Self {
        value.as_date_time()
    }
}

impl crate::etw::EtwPropConvert<ferrisetw::native::time::SystemTime> for time::OffsetDateTime {
