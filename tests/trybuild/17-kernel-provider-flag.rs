...
// Test: kernel provider with provider-wide enable_flag, events without individual flags
...
etw_provider! {
    #[etw_provider(kind = "kernel", guid = "90cbdc39-4a3e-11d1-84f4-0000f80464e3", enable_flag = 0x01000000)]
